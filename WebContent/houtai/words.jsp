		...
		<c:if test="${!empty wordsList}">
			<div class="inner_right_div2">
				...
				<div style="float: right; margin-right: 60px; margin-top: 20px;">
					<a href="HouWordsServlet?cpage=1">首页</a> <a
						href="HouWordsServlet?cpage=${subPage.upPageNum}">上一页</a> <a
						href="HouWordsServlet?cpage=${subPage.downPageNum}">下一页</a> <a
						href="HouWordsServlet?cpage=${subPage.totalPageNum}">尾页</a>
					页数&nbsp;${subPage.currentPageNum} / ${subPage.totalPageNum} &nbsp;
